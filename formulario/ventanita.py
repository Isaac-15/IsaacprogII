...
def registrar():
    ...
    sexo_masculino = "Masculino" if var_masculino.get() == 1 else ""
    sexo_femenino = "Femenino" if var_femenino.get() == 1 else ""

    mensaje = f"Nombre: {nombre}\nApellido: {apellido}\nEdad: {edad}\nDirección: {direccion}\nTeléfono: {telefono}\nSexo: {sexo_masculino} {sexo_femenino}"
